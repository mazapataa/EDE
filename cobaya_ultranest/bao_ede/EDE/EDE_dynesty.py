...
param_labels = [r'$\log(10^{10}A_s)$', r'$n_s$', r'$H_0$', r'$\Omega_b h^2$', 
                r'$\Omega_c h^2$', r'$m_\nu$', r'$w_0$', r'$\Omega_\mathrm{EDE}$', r'$\tau_{reio}$']
    ...
    try:
       ...
       #     return -np.inf
        ...
        if fail_count % 50 == 0 and rank == 0:
            ...
            print(f"Parameters: H0={params_dict['H0']:.2f}, omega_cdm={params_dict['omega_cdm']:.4f}, w0={params_dict['w0_fld']:.3f}")
        return -np.inf
...
def save_chains_and_info(results, output_dir='./ede_dynesty_output'):
    ...
    info_dict = {
        ...
        'sampling_mode': 'EDE_N_ur_fixed',
        'N_ur_value': 2.0328,
        'note': 'EDE model with N_ur fixed at 2.0328, m_ncdm sampled'
    }
