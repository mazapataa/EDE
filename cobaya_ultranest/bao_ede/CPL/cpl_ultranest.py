...
param_names = [
    'logA', 'n_s', 'H0', 'omega_b','omega_cdm', 'm_ncdm', 'w0_fld', 'wa_fld', 'tau_reio']
...
if __name__ == "__main__":
    ...
    # Save results
    with open('cpl_ultranest_results.pkl', 'wb') as f:
        pickle.dump(data_to_save, f)
    print("\n✓ Results saved: cpl_ultranest_results.pkl")
    ...
    create_triangle_plot(
        ...
        param_names=param_names,
        param_labels=param_labels,
        output_file='cpl_triangle_plot.pdf'
    )
    ...
    print("\nOutput files:")
    print("  - cpl_ultranest_results.pkl (all data)")
    print("  - cpl_triangle_plot.pdf (corner plot)")
    print("  - cpl_real_run/ (UltraNest run directory)")
    print("="*60)
