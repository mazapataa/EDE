...
param_names = [
    'logA', 'n_s', 'H0', 'omega_b','omega_cdm', 'm_ncdm', 'tau_reio']
...
def prior_transform(cube):
    ...
    prior_ranges = [
        ...
        (0.9, 1.00),      # n_s: [0.95, 0.98]
        (65.00, 75.00),    # H0: [65.0, 75.0]
...
if __name__ == "__main__":
    ...
    sampler = ultranest.ReactiveNestedSampler(
        ...
        my_likelihood,
        prior_transform,
        log_dir="cpl_real_run",  # Different directory for real run
    ...
    # Method 2: Try samples directly and compute weights
        ...
        with open('lcdm_ultranest_results_partial.pkl', 'wb') as f:
            pickle.dump(result, f)
        print("Saved partial results to: lcdm_ultranest_results_partial.pkl")
    ...
    # Save results
    with open('lcdm_ultranest_results.pkl', 'wb') as f:
        pickle.dump(data_to_save, f)
    print("\n✓ Results saved: lcdm_ultranest_results.pkl")
    ...
    create_triangle_plot(
        ...
        param_names=param_names,
        param_labels=param_labels,
        output_file='lcdm_triangle_plot.pdf'
    )
    ...
    print("\nOutput files:")
    print("  - lcdm_ultranest_results.pkl (all data)")
    print("  - lcdm_triangle_plot.pdf (corner plot)")
    print("  - lcdm_real_run/ (UltraNest run directory)")
    print("="*60)
