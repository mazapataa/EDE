...
# Import our modules
import lcdm_config as cfg
import lcdm_utils as utils

def main():
    print("========================================")
    print("   LCDM COSMOLOGY ANALYSIS (Modular)     ")
    print("========================================")

    # 1. Initialize logic helpers
    #    The wrapper handles the Cobaya model internally
    lcdm_wrapper = utils.LCDModelWrapper(cfg.COBAYA_INFO, cfg.PARAM_NAMES)
    ...
    try:
        logl = lcdm_wrapper.log_likelihood(fiducial_point)
    ...
    sampler = ultranest.ReactiveNestedSampler(
        ...
        loglike=lcdm_wrapper.log_likelihood,
    ...
    # 5. Save and Plot
    print("\n--- Processing Results ---")
    pkl_path = os.path.join(cfg.OUTPUT_DIR, "lcdm_results.pkl")
    plot_path = os.path.join(cfg.OUTPUT_DIR, "lcdm_triangle.pdf")
