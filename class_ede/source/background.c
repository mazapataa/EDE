...
int background_w_fld(
  ...
  case EDE:
    ...
    *w_fld = (-a*dOmega_ede_over_da/(3.0*Omega_ede_a*(1.0 - Omega_ede_a)) )  + ( a_eq/(3.0*(a+a_eq)) );
    break;
  }
  ...
  case EDE:
    ...
    double term2_int = log( (Omega_ede_a*(1.0 - pba->Omega0_fld)) / (pba->Omega0_fld*(1.0 - Omega_ede_a)) );
